...
def generate_launch_description():
    ...
    config_file_arg = DeclareLaunchArgument('config_file', default_value = 'assets_writer_my_robot.lua')
    urdf_filename_arg = DeclareLaunchArgument('urdf_filename', default_value = FindPackageShare('cartographer_config').find('cartographer_config') + '/urdf/my_robot.urdf')
