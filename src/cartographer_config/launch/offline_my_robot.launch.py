...
def generate_launch_description():
    ...
    configuration_directory_arg = DeclareLaunchArgument('configuration_directory', default_value = FindPackageShare('cartographer_config').find('cartographer_config') + '/config')
    configuration_basenames_arg = DeclareLaunchArgument('configuration_basenames', default_value = 'my_robot.lua')
    urdf_filenames_arg = DeclareLaunchArgument('urdf_filenames', default_value = FindPackageShare('cartographer_config').find('cartographer_config') + '/urdf/my_robot.urdf')
    ...
    set_remap1 = SetRemap('cx/pointcloud', 'points2')
